...
pub fn solve() !void {
    const n = readInt(u32);
    const l = readInt(u31);
    var lr: [2<<17]struct {i32, i32} = undefined;
    for (0..n) |i| {
        const x: i32 = readInt(u31);
        const r: i32 = readInt(u31);
        lr[i] = .{ x - r, x + r };
    }
    mem.sortUnstable(struct {i32, i32}, lr[0..n], {}, struct {fn lessThan(_: void, lhs: struct {i32, i32}, rhs: struct{i32, i32}) bool {
        return lhs[0] < rhs[0];
    }}.lessThan);
