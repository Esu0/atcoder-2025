...
var n: u8 = undefined;
var k: u8 = undefined;
var a: [18]u32 = undefined;
var b: [18][18]u32 = @splat(@splat(0));
var p: [18]u8 = undefined;
var ans: i64 = math.minInt(i64);

fn dfs(i: u8, rem: u8, sum: i64) void {
    if (rem == 0) {
        ans = @max(sum, ans);
        return;
    }
...
pub fn solve() !void {
    ...
    for (0..m) |_| {
        const u = readInt(u8) - 1;
        const v = readInt(u8) - 1;
        b[u][v] = readInt(u32);
        b[v][u] = b[u][v];
    }
    dfs(0, k, 0);
