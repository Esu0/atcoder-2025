...
pub fn solve() !void {
    ...
    for (0..m) |i| lr[i] = .{ readInt(u32), readInt(u32) };

    mem.sortUnstable(struct {u32, u32}, lr[0..m], {}, struct {fn lessThan(_: void, lhs: struct {u32, u32}, rhs: struct {u32, u32}) bool {
        return lhs[0] < rhs[0];
    }}.lessThan);
    var r: u32 = 1;
    var i: u32 = 0;
