...
var N: u32 = 0;
var mat1: [8][8]bool = @splat(@splat(false));
var mat2: [8][8]bool = @splat(@splat(false));
...
pub fn solve() !void {
    ...
    const m = readInt(u32);
    for (0..m) |_| {
        const a = readInt(u8) - 1;
        const b = readInt(u8) - 1;
        mat1[a][b] = true;
    }
    for (0..m) |_| {
        const c = readInt(u8) - 1;
        const d = readInt(u8) - 1;
        mat2[c][d] = true;
        mat2[d][c] = true;
    }
